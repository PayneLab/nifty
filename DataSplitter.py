...
class DataSplitter:
    ...
    def run_data_splitter(self, configs):
        ...
        elif not configs['split_for_FS'] and configs['split_for_train'] and not configs['split_for_validate']:
            configs['train_quant_table'] = configs['reference_quant_table']
            configs['train_meta_table'] = configs['reference_meta_table']
        elif not configs['split_for_FS'] and not configs['split_for_train'] and configs['split_for_validate']:
            configs['validate_quant_table'] = configs['reference_quant_table']
            configs['validate_meta_table'] = configs['reference_meta_table']
        elif configs['split_for_FS'] and configs['split_for_train'] and not configs['split_for_validate']:
            # TODO split into FS and train
            pass
        elif configs['split_for_FS'] and not configs['split_for_train'] and configs['split_for_validate']:
