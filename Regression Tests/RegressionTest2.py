...
def test_large_imbalanced_NA_Ben(num_samples=500, num_proteins=1000):
    ...
    # assertions
'''    score_20_30 = perm_results.loc[('Protein 30', 'Protein 20'), 'True_Score']
    if score_20_30 is None:
        raise AssertionError("Expected pair ('Protein 30', 'Protein 20') not found in results.")
    if score_20_30 < 1.0:
        raise AssertionError(f"Expected score 1.0 for ('Protein 30', 'Protein 20'), got {score_20_30}")
    else:
        print("Test passed: ('Protein 20', 'Protein 30') has score near 1.0.")
        print(f"Score for ('Protein 20', 'Protein 30'): {score_20_30}")
