...
| `feature_file` | Required if `find_features = false` **and** `train_model = true` | basic string | Path to `selected_features.tsv` file previously generated by NIFty's `find_features` mode. | |
